...
public class ChatController implements Observer<ChangeEvent> {
    ...
    public void initModel() {
        ...
        for (int i = 0; i < mesaje.size(); i++) {
            ...
            if (m.getFrom().equals(user)) {
                ...
                r.setStyle("-fx-fill: #fe4566");
            } else {
                r.setLayoutX(15);
                l.setLayoutX(25);
                r.setStyle("-fx-border-color: #ffa1b2");
            }
    ...
    public void downloadHandler() throws FileNotFoundException, DocumentException {
        if (from.getValue() != null && to.getValue() != null) {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\georg\\Documents\\Aan2_Semestru1\\MAP\\Laburi\\LabExtins3\\data\\chat.pdf"));
            document.open();
