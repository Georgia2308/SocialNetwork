...
public class Tuple<E1, E2> {
    ...
    public boolean equals(Object o) {
        ...
        Tuple<?, ?> tuple = (Tuple<?, ?>) o;
        if (e1.toString().equals(tuple.e1.toString()) && e2.toString().equals(tuple.e2.toString()))
            return true;
        if (e1.toString().equals(tuple.e2.toString()) && e2.toString().equals(tuple.e1.toString()))
            return true;
        return false;
    }
