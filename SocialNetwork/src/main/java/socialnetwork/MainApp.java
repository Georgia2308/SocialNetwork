...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        eventRepository = new EventDbRepository(url, username, pasword, new PrietenieValidator());
    ...
    private void initView(Stage primaryStage) throws IOException {
        primaryStage.getIcons().add(new Image("/design/logo.png"));
        primaryStage.setTitle("Pinch");
